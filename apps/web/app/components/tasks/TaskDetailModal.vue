<template>
    <BaseModal :show="isOpen && !!task" title="Detalles de la Tarea" subtitle="Vista de gestión de tarea"
        icon="task_alt" @close="$emit('close')">
        <!-- AI Summary Section -->
        <template #top v-if="task">
                ...
                <div class="detail-card stats-card">
                    ...
                    <div class="duration-section">
                        ...
                        <div class="duration-track">
                            <div class="duration-fill" :style="{ width: calculateProgress(task.duration) + '%' }"></div>
                        </div>
                    </div>
                </div>
